...
const AdDash = () => {
    ...
    const fetchEmail = () => {
      let savedEmail = JSON.parse(localStorage.getItem("admin"));    
      ...
      <Row noGutters style={{ height: "100vh" }}>
        ...
        >
          ...
          <Nav className="flex-column text-white">
            ...
            <Link to="/admin/signin" className="nav-link text-white">
              Logout
            </Link>
          </Nav>
        </Col>
        ...
        >
          <h1 className="text-center">WELCOME TO YOUR DASHBOARD ADMIN,  {userMail}</h1>
